...
import ru.degus.mytelegram.database.getFileFromStorage
import ru.degus.mytelegram.ui.message_recycler_view.views.MessageView
import ru.degus.mytelegram.utilits.WRITE_FILES
import ru.degus.mytelegram.utilits.asTime
import ru.degus.mytelegram.utilits.checkPermission
...
class HolderFileMessage(view: View): RecyclerView.ViewHolder(view), MessageHolder{
    ...
    private val chatReceivedFileTime: TextView = view.chat_received_file_message_time
    ...
    private val chatUserFileTime: TextView = view.chat_user_file_message_time
